...
<?php $__env->startSection('adminlist'); ?>
<body>
<div class="container">
        <div class="row">
	...
	<a href="<?php echo e(route('admin.home.pdf')); ?>" padding="right">Download List</a>
	<thead>
		<tr>
			<td>ID</td>
			<td>Name</td>
...
<?php echo $__env->make('layout/navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\ATP-3\Final\project\resources\views/admin/home/adminlist.blade.php ENDPATH**/ ?>