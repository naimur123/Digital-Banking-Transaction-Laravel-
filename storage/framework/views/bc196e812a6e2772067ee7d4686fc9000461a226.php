...
<?php $__env->startSection('managerlist'); ?>
<body>
<div class="container">
        <div class="row">
	...
	<div>
		<a href="<?php echo e(route('admin.home.mpdf')); ?>" padding="right">Download List</a>
    </div>
	<thead>
		<tr>
			<td>ID</td>
...
<?php echo $__env->make('layout/navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\ATP-3\Final\project\resources\views/admin/home/managerlist.blade.php ENDPATH**/ ?>